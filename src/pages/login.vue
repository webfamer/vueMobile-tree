  ...
  <div class="personal">
    <div class="personal-c">
      ...
      <div class="main">
        ...
        <div class="form">
          <Input v-model="loginInfo.phone" placeholder="手机号" @on-blur="checkTel" />
          <Input v-model="loginInfo.password" placeholder="密码" type="password" password />
        </div>
        <div class="btn">
          <Button type="success" long @click="userLogin">登录</Button>
          <div>
            <span class="clickRegister" @click="toForgetPassword">忘记密码？</span>
          </div>
        </div>
        <div class="tel">
